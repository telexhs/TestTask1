...
3. Тест ```test_TSP_wrong_matrix``` (Отрицательные элементы матрицы)
  - Входные данные: matrix =
    |   |   |   |   |   |   |
    |---|---|---|---|---|---|
    |None| 5 | -6 | 8 | 5|  8|
...
4. Тест ```test_TSP_wrong_shape``` (Неравильный размер матрицы)
  - Входные данные: matrix =
    |   |   |   |   |   |   |
    |---|---|---|---|---|---|
    |None| 5 | 6 | 8 | 5|  8|
...
5. Тест ```test_TSP_wrong_diag``` (Неправильные диагональные элементы)
...
1. Тест 1 - проверка запуска программы
 ...
 - Ожидаемый результат: программа запрашивает квадратную матрицу

2. Тест 2 - проверка ввода строки квадратной матрицы (положительная)
 - Действия: пользователь вводит список включающий целые числа >= 0 или None
 - Ожидаемый результат: программа ждет ввода следующей строки квадратной матрицы

3. Тест 3 - проверка ввода строки квадратной матрицы (отрицательная)
 - Действия: пользователь вводит список включающий не целые числа, целые числа < 0 или не числа 
 - Ожидаемый результат: программа выводит сообщение об ошибке и завершается

4. Тест 4 - проверка нахождения решения
  - Действия: пользователь вводит следующие строки "None 7 16 21 2 17", "13 None 21 15 43 23", "25 3 None 31 17 9", "13 10 27 None 33 12", "9 2 19 14 None 51", "42 17 5 9 23 None"
  - Ожидаемый результат: программа выводит "Путь - [1, 5, 4, 6, 3, 2]" "Константа - 49"
